...
**Primary outputs**:
- Feature registry: `aidlc-docs/features/features-registry.md`
...
- The current unit context:
  ...
  - Unit design outputs under `aidlc-docs/construction/<unit-name>/`
...
- Store outputs under:
  - `aidlc-docs/inception/onboarding/slides/engineers/`
  - `aidlc-docs/inception/onboarding/slides/product/`

If build is not configured, document the recommended build commands in:
- `aidlc-docs/inception/onboarding/README.md`
...
> - Engineer deck source: `aidlc-docs/inception/onboarding/engineers/onboarding-engineers.md`
> - Product deck source: `aidlc-docs/inception/onboarding/product/onboarding-product.md`
...
Mark the stage as complete for this unit in `aidlc-state.md`.
