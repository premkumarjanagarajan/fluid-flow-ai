...
Create `aidlc-docs/construction/build-and-test/build-instructions.mdc`:
...
Create `aidlc-docs/construction/build-and-test/unit-test-instructions.mdc`:
...
Create `aidlc-docs/construction/build-and-test/integration-test-instructions.mdc`:
...
Create `aidlc-docs/construction/build-and-test/performance-test-instructions.mdc`:
...
Create `aidlc-docs/construction/build-and-test/contract-test-instructions.mdc`:
- API contract validation between services
- Consumer-driven contract testing
- Schema validation

### Security Tests
Create `aidlc-docs/construction/build-and-test/security-test-instructions.mdc`:
...
### End-to-End Tests
Create `aidlc-docs/construction/build-and-test/e2e-test-instructions.mdc`:
...
Create `aidlc-docs/construction/build-and-test/build-and-test-summary.mdc`:
...
**MANDATORY**: Log the phase completion in `aidlc-docs/audit.mdc`:
