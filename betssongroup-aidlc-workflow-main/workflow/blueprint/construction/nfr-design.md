...
### Step 4: Store Plan
- Save as `aidlc-docs/construction/plans/{unit-name}-nfr-design-plan.mdc`
...
- Create `aidlc-docs/construction/{unit-name}/nfr-design/nfr-design-patterns.mdc`
- Create `aidlc-docs/construction/{unit-name}/nfr-design/logical-components.mdc`
