...
### Step 4: Store Plan
- Save as `aidlc-docs/construction/plans/{unit-name}-nfr-requirements-plan.mdc`
...
- Create `aidlc-docs/construction/{unit-name}/nfr-requirements/nfr-requirements.mdc`
- Create `aidlc-docs/construction/{unit-name}/nfr-requirements/tech-stack-decisions.mdc`
