...
- Read unit definition from `aidlc-docs/inception/application-design/unit-of-work.mdc`
- Read assigned stories from `aidlc-docs/inception/application-design/unit-of-work-story-map.mdc`
...
### Step 4: Store Plan
- Save as `aidlc-docs/construction/plans/{unit-name}-functional-design-plan.mdc`
...
- Create `aidlc-docs/construction/{unit-name}/functional-design/business-logic-model.mdc`
- Create `aidlc-docs/construction/{unit-name}/functional-design/business-rules.mdc`
- Create `aidlc-docs/construction/{unit-name}/functional-design/domain-entities.mdc`
