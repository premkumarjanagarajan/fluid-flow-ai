...
- [ ] Read workspace root and project type from `aidlc-docs/aidlc-state.mdc`
...
- [ ] Save complete plan as `aidlc-docs/construction/plans/{unit-name}-code-generation-plan.mdc`
...
- [ ] Mark Code Planning complete in `aidlc-state.mdc`
...
- [ ] Read the complete plan from `aidlc-docs/construction/plans/{unit-name}-code-generation-plan.mdc`
