...
- `requirement-verification-questions.mdc` (if needed)
- `requirements.mdc`

**Note**: User's initial request is captured in `audit.mdc` (no separate user-intent.md needed)
...
**All scenarios create the same artifacts**:
- `application-design.mdc`
- `component-diagram.mdc`

**Detail level varies by complexity**:

### Simple Scenario (Single Component)
- **application-design.mdc**: Basic component description, key methods
- **component-diagram.md**: Simple diagram with essential relationships

### Complex Scenario (Multi-Component System)
- **application-design.mdc**: Detailed component responsibilities, all methods with signatures, design patterns, alternatives considered
