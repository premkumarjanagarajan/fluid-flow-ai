...
- Use descriptive names: `{phase-name}-questions.mdc`
- Examples:
  - `classification-questions.mdc`
  - `requirements-questions.mdc`
  - `story-planning-questions.mdc`
  - `design-questions.mdc`
...
1. **Create clarification file**: `{phase-name}-clarification-questions.mdc`
