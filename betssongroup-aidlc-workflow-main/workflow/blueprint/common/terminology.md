...
- Examples: `story-generation-plan.mdc`, `unit-of-work-plan.mdc`

### Artifacts
Generated outputs from executing plans.
- Located in various `aidlc-docs/` subdirectories
- Examples: `requirements.mdc`, `stories.mdc`, `design.mdc`

### State Files
Files tracking workflow progress and status.
- `aidlc-state.mdc`: Overall workflow state
- `audit.mdc`: Complete audit trail of all interactions
