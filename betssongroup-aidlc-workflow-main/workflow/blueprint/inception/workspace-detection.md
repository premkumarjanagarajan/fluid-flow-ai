---
name: aidlc-inception-workspace-detection
description: Inception Workspace Generation
---
# Workspace Detection
...
Check if `aidlc-docs/aidlc-state.mdc` exists:
...
Create `aidlc-docs/aidlc-state.mdc`:
...
- **Structure patterns**: See code-generation.mdc Critical Rules
