...
3. **Document Assessment Decision**:
   - Create `aidlc-docs/inception/plans/user-stories-assessment.mdc`
...
**See `common/question-format-guide.mdc` for question formatting rules**
...
- Filename: `story-generation-plan.mdc`
...
- Before asking for approval, log the prompt with timestamp in `aidlc-docs/audit.mdc`
...
- [ ] Read the complete story plan from `aidlc-docs/inception/plans/story-generation-plan.mdc`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the user stories and personas at: `aidlc-docs/inception/user-stories/stories.mdc` and `aidlc-docs/inception/user-stories/personas.mdc`
...
- Mark User Stories stage complete in `aidlc-state.mdc`
