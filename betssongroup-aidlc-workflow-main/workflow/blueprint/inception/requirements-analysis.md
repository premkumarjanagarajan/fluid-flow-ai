...
## Mandatory Context Confirmation
Before solutioning, AI must confirm:
- Business objective
- Jurisdiction
- Domain criticality
- Regulatory surface

Missing context requires AI to stop and request clarification.
...
- Load `aidlc-docs/inception/reverse-engineering/architecture.mdc`
- Load `aidlc-docs/inception/reverse-engineering/component-inventory.mdc`
- Load `aidlc-docs/inception/reverse-engineering/technology-stack.mdc`
...
### Step 6: Generate Clarifying Questions (PROACTIVE APPROACH)
   - **ALWAYS** create `aidlc-docs/inception/requirements/requirement-verification-questions.mdc` unless requirements are exceptionally clear and complete
...
### Step 7: Generate Requirements Document
   - Create `aidlc-docs/inception/requirements/requirements.mdc`
...
### Step 9: Log and Proceed
   - Log approval prompt with timestamp in `aidlc-docs/audit.mdc`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the requirements document at: `aidlc-docs/inception/requirements/requirements.mdc`
