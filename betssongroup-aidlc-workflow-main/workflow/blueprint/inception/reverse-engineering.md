---
name: aidlc-inception-reverse-engineering
description: Inception Reverse Engineering
---
# Reverse Engineering
...
Create `aidlc-docs/inception/reverse-engineering/business-overview.mdc`:
...
Create `aidlc-docs/inception/reverse-engineering/architecture.mdc`:
...
Create `aidlc-docs/inception/reverse-engineering/code-structure.mdc`:
...
Create `aidlc-docs/inception/reverse-engineering/api-documentation.mdc`:
...
Create `aidlc-docs/inception/reverse-engineering/component-inventory.mdc`:
...
Create `aidlc-docs/inception/reverse-engineering/technology-stack.mdc`:
...
Create `aidlc-docs/inception/reverse-engineering/dependencies.mdc`:
...
Create `aidlc-docs/inception/reverse-engineering/code-quality-assessment.mdc`:
...
Create `aidlc-docs/inception/reverse-engineering/reverse-engineering-timestamp.mdc`:
...
Update `aidlc-docs/aidlc-state.mdc`:
