...
### 1. Analyze Context
- Read `aidlc-docs/inception/requirements/requirements.mdc` and `aidlc-docs/inception/user-stories/stories.mdc`
...
- Save as `aidlc-docs/inception/plans/application-design-plan.mdc`
...
- Create `aidlc-docs/inception/application-design/components.mdc` with:
  - Component name and purpose
  - Component responsibilities
  - Component interfaces
- Create `aidlc-docs/inception/application-design/component-methods.mdc` with:
...
- Create `aidlc-docs/inception/application-design/services.mdc` with:
  - Service definitions
  - Service responsibilities
  - Service interactions and orchestration
- Create `aidlc-docs/inception/application-design/component-dependency.mdc` with:
...
### 15. Update Progress
- Mark Application Design stage complete in `aidlc-docs/aidlc-state.mdc`
