...
**Outputs**:
- Engineer onboarding source: `aidlc-docs/inception/onboarding/engineers/onboarding-engineers.md`
- Product onboarding source: `aidlc-docs/inception/onboarding/product/onboarding-product.md`

**Optional build outputs** (if sli-dev build is configured in the repo):
- `aidlc-docs/inception/onboarding/slides/engineers/` (HTML/PDF as configured)
- `aidlc-docs/inception/onboarding/slides/product/` (HTML/PDF as configured)

## Step 1: Load Inputs (Mandatory)
- Reverse engineering artifacts under `aidlc-docs/inception/reverse-engineering/` including:
  - Business overview
  ...
  - Technology stack
  - Dependencies
- ADRs and technical principles from `inception/adrs-technical-principles.mdc` (for consistency, not for decisions)
...
- File: `aidlc-docs/features/features-registry.md`
...
- Provide text alternatives under diagrams as required by `common/content-validation.mdc`.

## Step 4: Generate Engineer Onboarding Deck
Create or update: `aidlc-docs/inception/onboarding/engineers/onboarding-engineers.md`
...
Source anchors:
- `aidlc-docs/inception/reverse-engineering/architecture.mdc`
...
Create or update: `aidlc-docs/inception/onboarding/product/onboarding-product.md`
...
Source anchors:
- `aidlc-docs/inception/reverse-engineering/business-overview.mdc`
...
## Generated/Updated
- Engineer onboarding: `aidlc-docs/inception/onboarding/engineers/onboarding-engineers.md`
- Product onboarding: `aidlc-docs/inception/onboarding/product/onboarding-product.md`
- Feature registry: `aidlc-docs/features/features-registry.md` (created or updated)
