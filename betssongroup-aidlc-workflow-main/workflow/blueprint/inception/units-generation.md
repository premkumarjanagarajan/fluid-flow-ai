...
- [ ] Generate `aidlc-docs/inception/application-design/unit-of-work.mdc` with unit definitions and responsibilities
- [ ] Generate `aidlc-docs/inception/application-design/unit-of-work-dependency.mdc` with dependency matrix
- [ ] Generate `aidlc-docs/inception/application-design/unit-of-work-story-map.mdc` mapping stories to units
- [ ] **Greenfield only**: Document code organization strategy in `unit-of-work.mdc` (see code-generation.mdc for structure patterns)
...
- Save as `aidlc-docs/inception/plans/unit-of-work-plan.mdc`
...
- [ ] Read the complete plan from `aidlc-docs/inception/plans/unit-of-work-plan.mdc`
...
- [ ] Update `aidlc-docs/aidlc-state.mdc` current status
...
- Log the user's approval response with timestamp in `aidlc-docs/audit.mdc`
- Include the exact user response text
- Mark the approval status clearly

## Step 19: Update Progress
- Mark Units Generation stage complete in `aidlc-docs/aidlc-state.mdc`
- Update the "Current Status" section
...
- All unit artifacts generated according to plan:
  - `unit-of-work.mdc` with unit definitions
  - `unit-of-work-dependency.mdc` with dependency matrix
  - `unit-of-work-story-map.mdc` with story mappings
