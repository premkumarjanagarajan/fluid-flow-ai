...
- Current unit context:
  ...
  - Unit design outputs under `{DEPT_FF_PATH}/initiatives/{INITIATIVE_NAME}/artefacts/construction/{unit-name}/`
...
- `{DEPT_FF_PATH}/initiatives/{INITIATIVE_NAME}/artefacts/features/features-registry.md`
...
Location: `{DEPT_FF_PATH}/initiatives/{INITIATIVE_NAME}/artefacts/inception/onboarding/engineers/onboarding-engineers.md`
...
Location: `{DEPT_FF_PATH}/initiatives/{INITIATIVE_NAME}/artefacts/inception/onboarding/product/onboarding-product.md`
...
- Store outputs under:
  - `{DEPT_FF_PATH}/initiatives/{INITIATIVE_NAME}/artefacts/inception/onboarding/slides/engineers/`
  - `{DEPT_FF_PATH}/initiatives/{INITIATIVE_NAME}/artefacts/inception/onboarding/slides/product/`

If build is not configured, document the recommended build commands in:
- `{DEPT_FF_PATH}/initiatives/{INITIATIVE_NAME}/artefacts/inception/onboarding/README.md`
...
## Updated
- Feature registry: `{DEPT_FF_PATH}/initiatives/{INITIATIVE_NAME}/artefacts/features/features-registry.md`
...
> - Engineer deck source: `{DEPT_FF_PATH}/initiatives/{INITIATIVE_NAME}/artefacts/inception/onboarding/engineers/onboarding-engineers.md`
> - Product deck source: `{DEPT_FF_PATH}/initiatives/{INITIATIVE_NAME}/artefacts/inception/onboarding/product/onboarding-product.md`
