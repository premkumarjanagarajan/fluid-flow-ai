...
**See `../../knowledge-core/depth-levels.md` for adaptive depth explanation**
...
- **MANDATORY**: User must answer the questions by filling all [Answer]: tags in the questions file (see `../../knowledge-core/question-format-guide.md`).
