...
**Conditional Stage**: Executes when user stories add value (see Intelligent Assessment Guidelines below).
...
### Step 18: Wait for Explicit Approval of Generated Stories
...
**Wait for explicit user approval** of both the story plan (Planning) and the generated stories (Generation) before proceeding to Workflow Planning.
