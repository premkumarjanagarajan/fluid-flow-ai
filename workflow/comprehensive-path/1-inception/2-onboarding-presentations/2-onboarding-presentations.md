...
- Reverse engineering artifacts under `{LOCAL_REPO_PATH}/initiatives/_project/reverse-engineering/` including:
  ...
  - Technology stack
  - Dependencies
- ADRs and technical principles from `../../knowledge-core/adrs-technical-principles.md` (for consistency, not for decisions)
...
### Step 2: Define Slide Sources and Conventions (Mandatory)
...
- Provide text alternatives under diagrams as required by `../../knowledge-core/content-validation.md`.
...
### Step 5: Content Validation (Mandatory)
...
1. Present a completion message in this structure:
