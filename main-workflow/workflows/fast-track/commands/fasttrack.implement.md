...
13. **Post-Implementation Documentation**:
   ...
   - After documentation updates are complete, the workflow proceeds to **Stage 6: Completion** (Commit, PR, Change Risk Report) as defined in `../../shared/commands/fluid-flow.md`.

Note: This command assumes a complete task breakdown exists in tasks.md. If tasks are incomplete or missing, suggest running fasttrack.tasks first (load `./fasttrack.tasks.md`) to regenerate the task list.
