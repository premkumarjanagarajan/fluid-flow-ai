...
handoffs: 
  - label: Create Tasks
    agent: fasttrack.tasks
    prompt: Break the plan into tasks
    send: true
  - label: Create Checklist
    agent: fasttrack.checklist
...
8. **Continue to next stage**: Present the next stage option to the user and wait for confirmation. When the user confirms, load and execute `./fasttrack.tasks.md`.
