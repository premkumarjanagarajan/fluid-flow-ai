...
**CRITICAL**
- **ALWAYS use Mermaid** for ALL diagrams (flowcharts, sequence diagrams, decision trees, architecture diagrams, etc.)
- **NEVER use ASCII art**, box-drawing characters, or plain-text diagrams
- If a diagram exists in ASCII/text form, it MUST be converted to Mermaid syntax
- Mermaid diagrams render consistently across tools and are easier to maintain
