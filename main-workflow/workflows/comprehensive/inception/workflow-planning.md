...
Create `specs/{BRANCH_NAME}/inception/plans/execution-plan.md`:
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the execution plan at: `specs/{BRANCH_NAME}/inception/plans/execution-plan.md`
...
Log in `specs/{BRANCH_NAME}/audit.md`:
