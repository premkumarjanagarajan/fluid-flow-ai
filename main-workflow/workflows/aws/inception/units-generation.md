...
- [ ] Generate `specs/{BRANCH_NAME}/inception/application-design/unit-of-work.md` with unit definitions and responsibilities
- [ ] Generate `specs/{BRANCH_NAME}/inception/application-design/unit-of-work-dependency.md` with dependency matrix
- [ ] Generate `specs/{BRANCH_NAME}/inception/application-design/unit-of-work-story-map.md` mapping stories to units
...
- Save as `specs/{BRANCH_NAME}/inception/plans/unit-of-work-plan.md`
...
- Ask: "**Unit of work plan complete. Review the plan in specs/{BRANCH_NAME}/inception/plans/unit-of-work-plan.md. Ready to proceed to generation?**"
...
- Mark Units Planning complete in specs/{BRANCH_NAME}/state.md
...
- [ ] Read the complete plan from `specs/{BRANCH_NAME}/inception/plans/unit-of-work-plan.md`
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the units generation artifacts at: `specs/{BRANCH_NAME}/inception/application-design/`
...
- Mark Units Generation stage complete in `specs/{BRANCH_NAME}/state.md`
- Update the "Current Status" section
