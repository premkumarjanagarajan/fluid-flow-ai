...
- Read unit definition from `specs/{BRANCH_NAME}/inception/application-design/unit-of-work.md`
- Read assigned stories from `specs/{BRANCH_NAME}/inception/application-design/unit-of-work-story-map.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the functional design artifacts at: `specs/{BRANCH_NAME}/construction/[unit-name]/functional-design/`
...
- Mark Functional Design stage complete in specs/{BRANCH_NAME}/state.md
