...
- [ ] Read workspace root and project type from `specs/{BRANCH_NAME}/state.md`
...
- [ ] Document exact paths (never specs/{BRANCH_NAME}/)
...
- [ ] Save complete plan as `specs/{BRANCH_NAME}/construction/plans/{unit-name}-code-generation-plan.md`
...
- [ ] Mark Code Planning complete in `specs/{BRANCH_NAME}/state.md`
...
- [ ] Read the complete plan from `specs/{BRANCH_NAME}/construction/plans/{unit-name}-code-generation-plan.md`
- [ ] Identify the next uncompleted step (first [ ] checkbox)
- [ ] Load the context for that step (unit, dependencies, stories)

## Step 11: Execute Current Step
- [ ] Verify target directory from plan (never specs/{BRANCH_NAME}/)
...
- [ ] Write to correct locations:
  ...
  - **Documentation**: `specs/{BRANCH_NAME}/construction/{unit-name}/code/` (markdown only)
...
> - **Documentation**: `specs/{BRANCH_NAME}/construction/[unit-name]/code/`
...
- Mark Code Generation stage as complete for this unit in specs/{BRANCH_NAME}/state.md
...
### Code Location Rules
- **Application code**: Workspace root only (NEVER specs/{BRANCH_NAME}/)
- **Documentation**: specs/{BRANCH_NAME}/ only (markdown summaries)
- **Read workspace root** from specs/{BRANCH_NAME}/state.md before generating code
