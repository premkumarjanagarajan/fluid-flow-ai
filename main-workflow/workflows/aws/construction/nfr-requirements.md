...
- Read functional design artifacts from `specs/{BRANCH_NAME}/construction/{unit-name}/functional-design/`
...
### Step 4: Store Plan
- Save as `specs/{BRANCH_NAME}/construction/plans/{unit-name}-nfr-requirements-plan.md`
...
- Create `specs/{BRANCH_NAME}/construction/{unit-name}/nfr-requirements/nfr-requirements.md`
- Create `specs/{BRANCH_NAME}/construction/{unit-name}/nfr-requirements/tech-stack-decisions.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR requirements at: `specs/{BRANCH_NAME}/construction/[unit-name]/nfr-requirements/`
...
- Mark NFR Requirements stage complete in specs/{BRANCH_NAME}/state.md
