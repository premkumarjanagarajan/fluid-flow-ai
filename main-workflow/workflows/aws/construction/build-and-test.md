...
Create `specs/{BRANCH_NAME}/construction/build-and-test/build-instructions.md`:
...
Create `specs/{BRANCH_NAME}/construction/build-and-test/unit-test-instructions.md`:
...
Create `specs/{BRANCH_NAME}/construction/build-and-test/integration-test-instructions.md`:
...
Create `specs/{BRANCH_NAME}/construction/build-and-test/performance-test-instructions.md`:
...
### Security Tests
Create `specs/{BRANCH_NAME}/construction/build-and-test/security-test-instructions.md`:
...
### End-to-End Tests
Create `specs/{BRANCH_NAME}/construction/build-and-test/e2e-test-instructions.md`:
...
Create `specs/{BRANCH_NAME}/construction/build-and-test/build-and-test-summary.md`:
...
**MANDATORY**: Log the phase completion in `specs/{BRANCH_NAME}/audit.md`:
...
## Step 11: Test Coverage Delta & Improvement Plan (CONDITIONAL - Post-Implementation)

**Execute IF**: Reverse engineering artifacts exist at `specs/_project/reverse-engineering/test-coverage-analysis.md`
...
**Execution**:
1. Load **Phase 2** instructions (Steps 7-11) from `../../shared/stages/test-coverage-analysis.md`
2. Load the Phase 1 baseline from `specs/_project/reverse-engineering/test-coverage-analysis.md`
...
5. Generate the Phase 2 output artifact at `specs/{BRANCH_NAME}/construction/coverage-improvement-plan.md`
6. Present coverage delta summary to user

---

## Step 12: Reverse Engineering Update (CONDITIONAL - Post-Implementation)
