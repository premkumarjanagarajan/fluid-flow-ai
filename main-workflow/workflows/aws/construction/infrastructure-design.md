...
- Read functional design from `specs/{BRANCH_NAME}/construction/{unit-name}/functional-design/`
- Read NFR design from `specs/{BRANCH_NAME}/construction/{unit-name}/nfr-design/` (if exists)
...
### Step 4: Store Plan
- Save as `specs/{BRANCH_NAME}/construction/plans/{unit-name}-infrastructure-design-plan.md`
- Include all [Answer]: tags for user input

### Step 5: Collect and Analyze Answers
- **MANDATORY**: Offer the user the choice between **Answer Manually** or **AI Best Judgement** mode (see `../../aws/memory/common/question-format-guide.md` for full details):
...
- Create `specs/{BRANCH_NAME}/construction/{unit-name}/infrastructure-design/infrastructure-design.md`
- Create `specs/{BRANCH_NAME}/construction/{unit-name}/infrastructure-design/deployment-architecture.md`
- If shared infrastructure: Create `specs/{BRANCH_NAME}/construction/shared-infrastructure.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the infrastructure design at: `specs/{BRANCH_NAME}/construction/[unit-name]/infrastructure-design/`
...
- Mark Infrastructure Design stage complete in specs/{BRANCH_NAME}/state.md
