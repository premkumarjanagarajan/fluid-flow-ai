...
- Read NFR requirements from `specs/{BRANCH_NAME}/construction/{unit-name}/nfr-requirements/`
...
### Step 4: Store Plan
- Save as `specs/{BRANCH_NAME}/construction/plans/{unit-name}-nfr-design-plan.md`
...
- Create `specs/{BRANCH_NAME}/construction/{unit-name}/nfr-design/nfr-design-patterns.md`
- Create `specs/{BRANCH_NAME}/construction/{unit-name}/nfr-design/logical-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR design at: `specs/{BRANCH_NAME}/construction/[unit-name]/nfr-design/`
...
- Mark NFR Design stage complete in specs/{BRANCH_NAME}/state.md
