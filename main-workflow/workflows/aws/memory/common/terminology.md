...
- Located in `specs/{BRANCH_NAME}/inception/plans/` or `specs/{BRANCH_NAME}/construction/plans/`
- Examples: `story-generation-plan.md`, `unit-of-work-plan.md`

### Artifacts
Generated outputs from executing plans.
- Located in various `specs/{BRANCH_NAME}/` subdirectories
- Project-level artifacts (reverse engineering): `specs/_project/reverse-engineering/`
